    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button size="mini" @click="renterDetail(scope.row.id)">申请详情</el-button>
        </template>
      </el-table-column>
    </el-table>
  </wms-tags>
...
export default {
  ...
  methods: {
    ...
    getRenterList() {
      $http.renterList(this.params).then((res) => {
        this.renter_data = res.data.data;
        const arr = [];
        this.renter_data.forEach((Item) => {
          const obj = {};
